...
const program = Effect.gen(function* () {
    ...
    yield* Console.log(`   • Chunking Strategy: ${result.chunkingStrategy ?? "N/A"}`);
    yield* Console.log(`   • Analyses Generated: ${result.partialAnalyses?.length ?? 0}`);
