...
export const authList = Command.make("list", { output: Options.text("output").pipe(Options.optional, Options.withAlias("o")) }, (opts) => Effect.gen(function* () {
    ...
    if (asJson) {
        yield* printJson({ providers }, getGlobalCompact(), outputFile ? { outputFile } : undefined);
    }
    else {
