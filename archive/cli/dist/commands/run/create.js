...
export const runCreate = Command.make("create", {
    prefix: Options.text("prefix").pipe(Options.optional, Options.withAlias("p"), Options.withDescription("Custom name prefix for the run")),
