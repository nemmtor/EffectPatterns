 ...
 */
export declare const ProductionLayers: Layer.Layer<ConfigService | NodeContext.NodeContext | MetricsService | MdxService | TemplateService | GoogleAiClient.GoogleAiClient | OpenAiClient.OpenAiClient | AnthropicClient.AnthropicClient | HttpClient.HttpClient | LLMService | OutputHandlerService | AuthService | OtelService | RunService, import("../services/config-service/errors.js").ConfigError | import("effect/ConfigError").ConfigError, never>;
/**
 ...
 * ```
 */
export declare const ProductionRuntime: ManagedRuntime.ManagedRuntime<ConfigService | NodeContext.NodeContext | MetricsService | MdxService | TemplateService | GoogleAiClient.GoogleAiClient | OpenAiClient.OpenAiClient | AnthropicClient.AnthropicClient | HttpClient.HttpClient | LLMService | OutputHandlerService | AuthService | OtelService | RunService, import("../services/config-service/errors.js").ConfigError | import("effect/ConfigError").ConfigError>;
export type ProductionEnv = NodeContext.NodeContext | HttpClient.HttpClient | ConfigService | AuthService | MetricsService | MdxService | OtelService | OutputHandlerService | RunService | LLMService | TemplateService;
/**
 ...
 * ```
 */
export declare const runProductionEffect: <A, E>(effect: Effect.Effect<A, E, ProductionEnv>) => Promise<A>;
/**
 ...
 * ```
 */
export declare const runProductionExit: <A, E>(effect: Effect.Effect<A, E, ProductionEnv>) => import("effect/Exit").Exit<A, import("../services/config-service/errors.js").ConfigError | import("effect/ConfigError").ConfigError | E>;
