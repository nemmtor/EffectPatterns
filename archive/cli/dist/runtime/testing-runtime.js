 ...
 */
import { NodeContext, NodeFileSystem, NodePath, NodeHttpClient } from "@effect/platform-node";
 ...
 */
const TestPlatformLayer = Layer.mergeAll(NodeContext.layer, NodeHttpClient.layer, NodeFileSystem.layer, NodePath.layer);
/**
 ...
 */
const TestAppServiceLayer = Layer.mergeAll(ConfigService.Default, AuthService.Default, MetricsService.Default, MdxService.Default, OtelService.Default, OutputHandlerService.Default, RunManagement.Default, LLMService.Default, TemplateService.Default);
/**
 ...
 */
const TestRuntimeWithConfig = ManagedRuntime.make(Layer.mergeAll(Layer.provideMerge(TestAppServiceLayer, TestPlatformLayer), Layer.setConfigProvider(TestConfigProvider)));
/**
 ...
 * ```
 */
export const TestRuntime = ManagedRuntime.make(Layer.mergeAll(Layer.provideMerge(TestAppServiceLayer, TestPlatformLayer), Layer.setConfigProvider(TestConfigProvider)));
/**
 ...
 * ```
 */
export const runTestEffect = (effect) => {
 ...
 * ```
 */
export const runTestExit = (effect) => {
