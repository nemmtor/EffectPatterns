...
export const errorMatchers = {
    isInvalidMdxFormatError: (error) => typeof error === "object" && error !== null &&
        "_tag" in error &&
        error._tag === "InvalidMdxFormatError",
    isInvalidFrontmatterError: (error) => typeof error === "object" && error !== null &&
        "_tag" in error &&
        error._tag === "InvalidFrontmatterError",
    isUnsupportedProviderError: (error) => typeof error === "object" && error !== null &&
        "_tag" in error &&
        error._tag === "UnsupportedProviderError",
    isAiError: (error) => typeof error === "object" && error !== null &&
        "_tag" in error &&
        error._tag === "AiError"
};
