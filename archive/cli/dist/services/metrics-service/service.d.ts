...
declare const MetricsService_base: Effect.Service.Class<MetricsService, "MetricsService", {
    readonly effect: Effect.Effect<{
        ...
        extractLLMUsage: (response: unknown, provider: string, model: string) => Effect.Effect<LLMUsage, never, never>;
        saveCommandMetrics: (outputPath?: string, format?: "json" | "ndjson") => Effect.Effect<void, import("@effect/platform/Error").PlatformError, Fs.FileSystem | Path.Path>;
