    ...
    effect: Effect.gen(function* () {
        ...
        return {
            ...
            extractLLMUsage: (response, provider, model) => Effect.gen(function* () {
                ...
                const hasUsage = (x) => typeof x === "object" && x !== null && "usage" in x;
                const usageUnknown = hasUsage(response)
                    ? response.usage
                    : undefined;
                const usageObj = typeof usageUnknown === "object" && usageUnknown !== null
                    ? usageUnknown
                    : {};
                ...
                const totalTokens = getNum(usageObj, "totalTokens") || (inputTokens + outputTokens + thinkingTokens);
                // Calculate costs
