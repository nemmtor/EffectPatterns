...
export const health = Command.make("health", {
    provider: Options.choice("provider", ["openai", "anthropic", "google"]).pipe(Options.optional, Options.withDescription("Check specific provider health")),
...
}, ({ provider, detailed, json, output, force, quiet }) => Effect.gen(function* () {
