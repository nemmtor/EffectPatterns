...
export const readMdxAndFrontmatter = (filePath) => FileSystem.FileSystem.pipe(Effect.flatMap((fs) => fs.readFileString(filePath)), Effect.flatMap((content) => 
...
export function updateMdxContent(originalFullMdxContent, updatedFrontmatter) {
