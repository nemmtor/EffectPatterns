 ...
 */
export declare const ProductionLayers: Layer.Layer<AuthService | ConfigService | NodeContext.NodeContext | GoogleAiClient.GoogleAiClient | OpenAiClient.OpenAiClient | AnthropicClient.AnthropicClient | MetricsService | TemplateService | import("@effect/platform/HttpClient").HttpClient | LLMService | OtelService | RunService, import("../services/config-service/service.js").ConfigError | import("effect/ConfigError").ConfigError, never>;
/**
 ...
 * ```
 */
export declare const ProductionRuntime: ManagedRuntime.ManagedRuntime<AuthService | ConfigService | NodeContext.NodeContext | GoogleAiClient.GoogleAiClient | OpenAiClient.OpenAiClient | AnthropicClient.AnthropicClient | MetricsService | TemplateService | import("@effect/platform/HttpClient").HttpClient | LLMService | OtelService | RunService, import("../services/config-service/service.js").ConfigError | import("effect/ConfigError").ConfigError>;
/**
 ...
 * ```
 */
export declare const runProductionExit: <A, E>(effect: Effect.Effect<A, E>) => import("effect/Exit").Exit<A, import("../services/config-service/service.js").ConfigError | import("effect/ConfigError").ConfigError | E>;
