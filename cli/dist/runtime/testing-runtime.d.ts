 ...
 * ```
 */
export declare const TestRuntime: ManagedRuntime.ManagedRuntime<AuthService | ConfigService | NodeContext.NodeContext | MetricsService | TemplateService | LLMService | OtelService | RunManagement, import("../services/config-service/service.js").ConfigError>;
/**
 ...
 * ```
 */
export declare const runTestEffect: <A, E>(effect: Effect.Effect<A, E>) => Promise<A>;
/**
 ...
 * ```
 */
export declare const runTestExit: <A, E>(effect: Effect.Effect<A, E>) => import("effect/Exit").Exit<A, import("../services/config-service/service.js").ConfigError | E>;
