...
export declare const errorMatchers: {
    isInvalidMdxFormatError: (error: any) => boolean;
    isInvalidFrontmatterError: (error: any) => boolean;
    isUnsupportedProviderError: (error: any) => boolean;
    isAiError: (error: any) => boolean;
};
