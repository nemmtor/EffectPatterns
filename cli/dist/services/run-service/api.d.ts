...
export declare const getRunPath: Effect.Effect<string, import("@effect/platform/Error").PlatformError | import("./errors.js").NoActiveRunError, RunService>;
export declare const getRunFilePath: (filename: string) => Effect.Effect<string, import("@effect/platform/Error").PlatformError | import("./errors.js").NoActiveRunError, RunService>;
