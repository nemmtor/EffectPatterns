...
declare const RunService_base: Effect.Service.Class<RunService, "RunService", {
    ...
    readonly effect: Effect.Effect<{
        ...
        getRunPath: () => Effect.Effect<string, import("@effect/platform/Error").PlatformError | Error, never>;
        getRunFilePath: (filename: string) => Effect.Effect<string, import("@effect/platform/Error").PlatformError | Error, never>;
