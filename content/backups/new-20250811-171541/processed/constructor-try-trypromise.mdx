...
useCase:
  ...
  - Async
  - Interop
summary: Use try and tryPromise to safely wrap synchronous or asynchronous
  computations that may throw or reject, capturing errors in the Effect world.
tags:
  - try
  - tryPromise
  - constructor
  ...
  - interop
rule:
  description: Use try and tryPromise to lift code that may throw or reject into
    Effect, capturing errors in the failure channel.
related:
...
author: PaulJPhilp
expectedOutput: >-
  timestamp=2025-08-07T18:29:29.633Z level=INFO fiber=#0 message="Effect.try
  result: Error: Parse error: SyntaxError: JSON Parse error: Expected '}'"

  timestamp=2025-08-07T18:29:29.701Z level=INFO fiber=#0
  message="Effect.tryPromise result: Error: Network error: Error: Unable to
  connect. Is the computer able to access the url?"
---
...
<Example path="./src/constructor-try-trypromise.ts" />
