...
useCase:
  ...
  - Interop
  - Conversion
summary: Use fromNullable, fromOption, and fromEither to convert nullable
  values, Option, or Either into Effects or Streams, enabling safe and
  composable interop.
tags:
  - fromNullable
  - fromOption
  ...
  - conversion
rule:
  description: Use fromNullable, fromOption, and fromEither to lift nullable
    values, Option, or Either into Effects or Streams for safe, typeful interop.
related:
  - constructor-succeed-some-right
  - constructor-fail-none-left
author: PaulJPhilp
expectedOutput: >-
  timestamp=2025-08-07T18:29:29.344Z level=INFO fiber=#0
  message="Effect.fromNullable result: hello"

  timestamp=2025-08-07T18:29:29.345Z level=INFO fiber=#0
  message="Effect.fromOption result: 42"

  timestamp=2025-08-07T18:29:29.345Z level=INFO fiber=#0
  message="Effect.fromEither result: success"
---
