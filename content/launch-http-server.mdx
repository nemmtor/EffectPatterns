Excellent. Let's begin with the first pattern for Module 2.

Here is the complete file for `http-server-listen.md`, written according to your specified format. This pattern establishes the fundamental starting point for any web application built with Effect.
