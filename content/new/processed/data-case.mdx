...
id: "data-case"
skillLevel: "beginner"
useCase: ["Data Types", "Case Constructors", "Domain Modeling", "Structural Equality"]
summary: "Use Data.case to create case constructors for data types with built-in structural equality and hashing, enabling type-safe domain modeling."
tags: ["Data.case", "case-constructor", "structural-equality", "domain-modeling", "data-type", "effect"]
rule:
  description: "Use Data.case to create case constructors for data types, providing automatic structural equality and hashing for domain objects."
related: ["data-tagged", "data-struct", "pattern-matchtag"]
author: "PaulJPhilp"
---
