...
useCase:
  ...
  - Performance
  - Debugging
summary: Use Effect.withSpan to create custom tracing spans, providing detailed
...
tags:
  ...
  - effect
rule:
  description: Use Effect.withSpan to create and annotate tracing spans for
    operations, enabling distributed tracing and performance analysis.
related:
...
expectedOutput: timestamp=2025-08-07T18:29:29.609Z level=INFO fiber=#0
