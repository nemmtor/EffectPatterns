...
import { McpClient, McpClientLayer } from "../services/McpClient"
import { useEffectCallback } from "../hooks/useEffectState"
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      type: "system",
      content: "Hello! I can help you search for Effect patterns. Try searching for something like 'error handling' or 'concurrent'.",
    },
  ])
